...
import { Trophy, TrendingUp, Users, Wallet, Activity as ActivityIcon, Zap } from "lucide-react";
...
export function Dashboard() {
  ...
  const statCards = [
    ...
    {
      label: "Global Rank",
      value: `#${summary?.globalRank?.toLocaleString() ?? "—"}`,
      sub: "Top 1%",
      Icon: Trophy,
      accent: "#f59e0b",
    },
    ...
    {
      label: "Budget",
      value: `£${summary?.budgetRemaining?.toFixed(1) ?? "0.0"}m`,
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        {/* Dark overlay — gradient from bottom so cards sit on a dark surface */}
        <div
        ...
        />
        {/* Warm orange-red glow edge hint */}
        <div
